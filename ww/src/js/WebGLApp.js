...
export default class WebGLApp {
  ...
  #composer
  #activeView
  constructor({ canvas, isDevelopment, mode = MODE.DEFAULT }) {
    // Options
    this.#canvas = canvas
  ...
  _initViews() {
    this.#views = {
      main: new MainView({ renderer: this.#renderer.instance, config: { name: 'Main' }, debug: Debugger, mode: this.#mode }),
    }
