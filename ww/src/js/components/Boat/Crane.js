...
export default class Crane {
  ...
  constructor(gltf, boatMesh, debug) {
    ...
    // Safety check: If crane object doesn't exist in the model, skip initialization
    if (!this.#crane) {
      console.warn('Crane object not found in boat model - crane disabled')
  ...
  update({ time, delta }) {
    // Skip update if crane wasn't initialized
