...
export default class ResumeBillboard {
  ...
  #init() {
    ...
    // Create geometry (billboard size in world units) - increased for better readability
    this.#geometry = new PlaneGeometry(350, 350)
    ...
    this.#baseY = 150 // Height above water - raised for better visibility
